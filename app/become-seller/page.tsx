...
import MultiStepSellerForm from "@/components/seller/MultiStepSellerForm";
...
export default async function BecomeSellerPage() {
  ...
  // If already a provider and not pending
  if (user.role === "provider" && user.providerStatus === "none") {
    redirect("/dashboard?role=provider");
  }
